...
export const metadata: Metadata = {
  title: 'AWS SOA-C03 스터디',
  description: 'AWS SOA-C03 시험 문제 학습',
}

export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="ko">
      <body className="bg-[#c0c0c0] min-h-screen">
        <nav className="bg-white border-b border-gray-200 px-4 py-3 flex items-center gap-6 sticky top-0 z-10">
          <Link href="/" className="font-bold text-lg text-blue-600">SOA-C03</Link>
          ...
          <Link href="/review" className="text-sm text-gray-600 hover:text-green-600 font-medium">복습</Link>
        </nav>
